		...
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Ecommerce</span>
				...
				<ul class="sidebar-nav">
					...
					<li class="sidebar-item {{request()->routeIs('customer.affilated') ? 'active' : ''}}">
						<a class="sidebar-link" href="{{route('customer.affilated')}}">
                      <i class="align-middle" data-feather="users"></i> <span class="align-middle">Affilated</span>
            </a>
					</li>
